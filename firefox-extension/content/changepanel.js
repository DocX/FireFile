   ...
   template: domplate({
      ...
      DIV({"class": "cssFireFileSitesPanel",  role : 'presentation'},
          ...
          getOptionsMenuItems: function() {
             ...
             var ret = [
               {
                  label: Firebug.FireFile.__("save_all_changes"),
                  tooltiptext: $STR("SaveAllChangesTooltip", "strings_firefile"),
                  command: function() { Firebug.FireFile.saveAllChanges(); }                          
               },
               {
                  label: Firebug.FireFile.__("cancel_all_changes"), 
                  tooltiptext: $STR("CancelAllChangesTooltip", "strings_firefile"), 
                  command: function() { Firebug.FireFile.cancelAllChanges(); }
               }
             ];
             ...
             // Manual add to allowed sites
             ret.push(
               {
                  label: Firebug.FireFile.__("manual_enable"),
                  tootiptext: $STR("ManualEnableTooltip", "strings_firefile"),
                  command: function() {Firebug.FireFile.allowCurrentSite(); }
               }
             );
